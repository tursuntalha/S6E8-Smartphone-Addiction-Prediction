...
gbdt = pd.read_csv(f'{SUB}/2026-08-19/lgbm_xgb_cat_ABD_combined_2026-08-19.csv').sort_values('id').reset_index(drop=True)
nn = pd.read_csv(f'{SUB}/2026-08-19/nn_lookup_transformer_2026-08-19.csv').sort_values('id').reset_index(drop=True)
...
sub_path = f'{SUB}/2026-08-19/blend_gbdt_nn_2026-08-19.csv'
