...
sub_path = 'sub/2026-08-19/lgbm_xgb_cat_ABD_combined_2026-08-19.csv'
sub.to_csv(sub_path, index=False)
print(f'Saved: {sub_path}')

np.save('nn_cache/gbdt_abd_oof.npy', blend_oof)
np.save('nn_cache/gbdt_abd_test_pred.npy', blend_pred)
