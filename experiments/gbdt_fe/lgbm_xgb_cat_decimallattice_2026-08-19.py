"""
Izole test D: K1 bundle (48 ozellik) + "decimal lattice" (ondalik basamak) ozellikleri.
tomasa2'nin notebook'unda (+0.0001, kucuk ama gercek, TE'nin YAKALAYAMADIGI ayri bir
kanal): frac_c = v - floor(v) ve d1_c = floor(v*10)%10 (ilk ondalik basamak), TE her
exact-degeri ayri kategori saydigi icin ".2 ile bitenler ortak bir seyi paylasiyor"
bilgisini yakalayamiyor - bu ayrik feature bunu dogrudan veriyor.
Sadece GERCEK ondalik hassasiyeti olan 6 sutuna uygulaniyor (daily_screen_time_hours,
social_media_hours, gaming_hours, work_study_hours, sleep_hours, weekend_screen_time) -
age/notifications_per_day/app_opens_per_day zaten tam sayi, ondalik tasimiyor.
...
print(f'Ozellik sayisi: {X.shape[1]} (K1 48 + {len(decimal_feat_cols)} decimal-lattice)')
...
sub_path = f'{SUB}/2026-08-19/lgbm_xgb_cat_decimallattice_2026-08-19.csv'
